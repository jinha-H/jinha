...
* **3-17** call/apply 메서드 활용(1) 유사 배열객체에 배열 메서드를 적용한 예시
* **3-18** call/apply 메서드 활용(2) arguments, NodeList에 배열 메서드를 적용한 예시
* **3-19** call/apply 메서드 활용(3) 문자열에 배열 메서드를 적용한 예시
* **3-20** call/apply 메서드 활용(4) ES6의 Array.From 메서드
* **3-21** call/apply 메서드 활용 - 생성자 내부에서 다른 생성자 호출
